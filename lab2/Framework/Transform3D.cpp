...
void Transform3D::perspectiveProjectionMatrix(float xc, float yc, float zc)
{
	...
	//folosim scrierea vectori coloana
	ParallProjectionMatrix[0][0] = 1;    ParallProjectionMatrix[0][1] = 0;      ParallProjectionMatrix[0][2] = -xc/zc;        ParallProjectionMatrix[0][3] = 0;
	ParallProjectionMatrix[1][0] = 0;    ParallProjectionMatrix[1][1] = 1;  ParallProjectionMatrix[1][2] = -yc/zc;  ParallProjectionMatrix[1][3] = 0;
	ParallProjectionMatrix[2][0] = 0;    ParallProjectionMatrix[2][1] = 0;  ParallProjectionMatrix[2][2] = 0;   ParallProjectionMatrix[2][3] = 0;
	ParallProjectionMatrix[3][0] = 0;	  ParallProjectionMatrix[3][1] = 0;       ParallProjectionMatrix[3][2] = -1/zc;        ParallProjectionMatrix[3][3] = 1;
